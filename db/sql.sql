...
INSERT INTO `Friends` (`id`, `name`, `url`, `connected`, `statut`) VALUES
(1, 'Jean', 'http://localhost:8000/Sr05-Project/Distributed_Facebook_API/1.0.0/', 1, 'friend'),
(2, 'Marc', 'http://localhost:8001/Sr05-Project/Distributed_Facebook_API/1.0.0/', 0, 'friend');
...
INSERT INTO Snapshot(data, lastUpdate, url)
VALUES ('{test}','2021-06-14 13:52:15','http://localhost:8002/Sr05-Project/Distributed_Facebook_API/1.0.0/');